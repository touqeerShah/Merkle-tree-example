...
export interface PTNFTInterface extends utils.Interface {
  functions: {
    "CLAME_USERID_VOUCHER()": FunctionFragment;
    "DEFAULT_ADMIN_ROLE()": FunctionFragment;
    "_verify((string,bytes,bytes,bytes))": FunctionFragment;
    "approve(address,uint256)": FunctionFragment;
    "balanceOf(address)": FunctionFragment;
    "getApproved(uint256)": FunctionFragment;
    "getApprovedOrOwner(address,uint256)": FunctionFragment;
    ...
    "redeem(address,(string,bytes,bytes,bytes))": FunctionFragment;
    "renounceOwnership()": FunctionFragment;
    "renounceRole(bytes32,address)": FunctionFragment;
    "revertApprovalForAll(address,uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "getApprovedOrOwner",
    values: [PromiseOrValue<string>, PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    ...
    values: [PromiseOrValue<string>, UserIdVoucherStruct]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "revertApprovalForAll",
    values: [PromiseOrValue<string>, PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
  ...
  events: {
    ...
    "IdVerifedAndIssued(bytes,address,uint8)": EventFragment;
    "OwnershipTransferred(address,address)": EventFragment;
    "RedeemVoucher(address,uint256,address)": EventFragment;
...
export interface RedeemVoucherEventObject {
  signer: string;
  tokenId: BigNumber;
  redeemer: string;
}
...
export interface PTNFT extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PTNFTInterface;
  ...
  functions: {
    ...
    setFingerPrintAddress(
      _figureprintOracle: PromiseOrValue<string>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
  ...
  filters: {
    ...
    "IdVerifedAndIssued(bytes,address,uint8)"(
    ...
    "RedeemVoucher(address,uint256,address)"(
