...
export interface OrcaleUrlProviderAdminInterface extends utils.Interface {
  functions: {
...
export interface OrcaleUrlProviderAdmin extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: OrcaleUrlProviderAdminInterface;
